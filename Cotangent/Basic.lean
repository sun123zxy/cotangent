...
#check rank_eq_of_equiv_equiv -- for reference
...
/--
A neater proof might be possible with projective modules, but this results in larger dependencies.
-/
...
/--
In a local ring, the span rank of the maximal ideal equals the dimension of the cotangent space
